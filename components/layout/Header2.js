...
import LogoWGenr from './../../public/images/logo-6.png';
import LogoDGenr from './../../public/images/logo-7.png';
                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box">
                        <div className="upper-box">
                            <div className="nav-logo"><Link href="/"><Image src={LogoWGenr} title='K3Media' /></Link></div>
                        ...
                        <ul className="contact-list-one">
                            <li>
                                ...
                                <div className="contact-info-box">
                                    ...
                                    <Link href="/tel:+91 9047355000">+91 9047355000</Link>
                                </div>
                            </li>
                            <li>
                                {/* Contact Info Box */}
                ...
                <div className={`sticky-header ${scroll ? "fixed-header animated slideInDown" : ""}`}>
                    <div className="auto-container">
                        <div className="inner-container">
                            {/*Logo*/}
                            <div className="logo">
                                <Link href="/" title><Image src={LogoDGenr} title='K3Media' /></Link>
                            </div>
                            {/*Right Col*/}
                            <div className="nav-outer">
                                {/* Main Menu */}
